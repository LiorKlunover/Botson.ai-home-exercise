  ...
  const filterFeedsByDate = (feeds: Feed[], startDate: string | null, endDate: string | null) => {
    ...
    return feeds.filter(feed => {
      ...
      try {
        ...
        // Silently handle date parsing errors by excluding invalid dates
        return false;
      }
      ...
      if (startDate && endDate) {
        ...
        return feedDateStr >= startDate && feedDateStr <= endDate;
      } else if (startDate) {
        return feedDateStr >= startDate;
      } else if (endDate) {
        return feedDateStr <= endDate;
      }
